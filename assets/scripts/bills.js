// Import bill data
import { bills, SUPPORT, OPPOSE, SUPPORT_AMENDED, OPPOSE_AMENDED } from "/assets/data/bills.js";
...
if (isHomepage) {
  ...
  function applyFilters() {
    ...
    if (currentFilter !== "All") {
      ...
      switch(currentFilter) {
        case "Support": filterBadge = SUPPORT; break;
        case "Support If Amended": filterBadge = SUPPORT_AMENDED; break;
        case "Oppose": filterBadge = OPPOSE; break;
        case "Oppose Unless Amended": filterBadge = OPPOSE_AMENDED; break;
      }
      if (filterBadge) {
  ...
  document.querySelectorAll(".filter-btn").forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      switch (btn.id) {
        case "filter-all": currentFilter = "All"; break;
        case "filter-support": currentFilter = "Support"; break;
        case "filter-support-amended": currentFilter = "Support If Amended"; break;
        case "filter-oppose": currentFilter = "Oppose"; break;
        case "filter-oppose-amended": currentFilter = "Oppose Unless Amended"; break;
      }
