-- SPAN bill research (v1): safe read for anyone with members.bills permission.
-- Omits internal fields: review_notes, reviewed_by, reviewed_at.
...
COMMENT ON FUNCTION public.get_bills_research() IS 'Returns non-internal bill fields for dashboard Research tab; requires members.bills permission.';
