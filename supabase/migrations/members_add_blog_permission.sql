-- Blog writers: Medium OTP forwarding is gated by members.blog (set by execs in member management).

ALTER TABLE public.members
  ADD COLUMN IF NOT EXISTS blog BOOLEAN DEFAULT false NOT NULL;

-- Keep create_member / update_member in sync (latest body from fix_registration_complete + blog).
